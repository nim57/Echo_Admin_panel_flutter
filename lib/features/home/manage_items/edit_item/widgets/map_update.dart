...
class MapPickerScreenUpdate extends StatefulWidget {
  final String initialLocation;

  const MapPickerScreenUpdate({super.key, required this.initialLocation});

  @override
  State<MapPickerScreenUpdate> createState() => _MapPickerScreenUpdateState();
}

class _MapPickerScreenUpdateState extends State<MapPickerScreenUpdate> {
  ...
  CameraPosition _getInitialCameraPosition() {
    ...
    try {
      final uri = Uri.parse(widget.initialLocation);
